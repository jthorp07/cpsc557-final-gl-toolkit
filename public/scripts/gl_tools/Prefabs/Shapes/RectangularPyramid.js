...
function rectangularPyramidVertices(baseWidth, baseDepth, height) {
...
function rectangularPyramidNormals(vertices) {
    // Facing +Z
...
export class RectangularPyramid extends BaseShape {
    constructor(baseWidth, baseDepth, height) {
        ...
        super(vertices, rectangularPyramidNormals(vertices), rectangularPyramidRelativeIndices(), rectangularPyramidTextureCoordinates());
    }
}
